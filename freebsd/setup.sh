...
ssh-keygen -f "/home/$USER/.ssh/known_hosts" -R "192.168.70.4"
...
ssh vagrant@192.168.70.4 -i ~/.vagrant.d/insecure_private_key -o "StrictHostKeyChecking no" 'echo -e "password1\npassword1" | sudo passwd root'
